...
with tab1:
    ...
    st.markdown("""
        ...
        .info-box {
            ...
            padding: 10px 15px;  /* Adjust padding to be smaller */
            border-radius: 5px;
            border: 1px solid rgba(0, 123, 255, 0.5);  /* Semi-transparent border */
            margin-bottom: 10px;  /* Reduced space between the box and the next section */
